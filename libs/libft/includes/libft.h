...
/*   Updated: 2024/01/11 14:19:37 by sgabsi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @file libft.h
	...
	* @brief This file contains the declarations of various 
...
/**
	...
	* @brief Trims the characters specified in 'set' from the 
...
/**
	...
	* @brief Allocates memory for an array of 'count' elements of 'size' 
...
/**
	...
	* @brief Duplicates the string 's1' and returns a 
...
/**
	...
	* @brief Writes the string 's' followed by a newline character to 
